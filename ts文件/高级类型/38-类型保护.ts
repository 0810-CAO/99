...
if (isString(value11)) {
  console.log(value11.length);
} else {
  console.log(value11.toFixed());
}
/*
...
let getRandomObject = (): (Person001 | Animal) => {
  let num = Math.random();
  return (num >= 0.5) ? new Person001() : new Animal();
};
let obj = getRandomObject();
console.log(obj);
if (obj instanceof Person001) {
